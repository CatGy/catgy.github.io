    ...
    article_figures: [
      {
        ...
        alt: "Green Thermique Business front card",
        caption:
    ...
    article_figures: [
      {
        ...
        alt: "Greenthermique Stroryboard",
        caption: "Storyboard caroussel",
        fullScreen: true,
        title: "",
        text: "",
        modal_id: "gtst1",
        ...
        isSvg: false,
        imgList: [
          "'/images/greenthermique/GT Storyboard@4x.png'",
          "'/images/greenthermique/scene1@4x.png'",
          "'/images/greenthermique/scene2@4x.png'",
          "'/images/greenthermique/scene3@4x.png'",
          "'/images/greenthermique/scene4@4x.png'",
          "'/images/greenthermique/scene5@4x.png'",
          "'/images/greenthermique/scene6@4x.png'",
          "'/images/greenthermique/scene7@4x.png'",
          "'/images/greenthermique/scene8@4x.png'",
          "'/images/greenthermique/scene9@4x.png'",
          "'/images/greenthermique/scene10@4x.png'",
          "'/images/greenthermique/scene11@4x.png'",
          "'/images/greenthermique/scene12@4x.png'",
        ],
        captionList: [
          "'Storyboard'",
          "'Logo elements fade in from every angle of the screen.'",
          "'The elements sun, leaves, roof, solar panel and energy icons become more visible and continue to transition to the center of the screen.'",
          "'Elements of the logo continue to expand.'",
          "'The elements get closer to one another.'",
          "'The elements are almost set in to place to form the logo.'",
          "'The elements are close to each other and start forming the logo.'",
          "'The logo is formed and composed of the sun, roof, solar panel, leaves windows with environment sources icons ( wind, water, fire, ice).'",
          "'The business name starts appearing in form of type effect starting from the left to right side of the screen above the house and sun.'",
          "'The brand name continues to reveal its full name.'",
          "'The name of the business continues to type write.'",
          "'The name of the business continues to type write.'",
          "'All logo elements are fully displayed representing the brand focus on eco-friendliness.'",
        ],
      },
    ],
    subtitle: "Storyboard",
